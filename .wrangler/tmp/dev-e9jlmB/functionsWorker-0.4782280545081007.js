  ...
  try {
    ...
    if (path === "/bookings") {
      ...
      if (request.method === "POST") {
        ...
        const newId = id || "bk-" + Math.floor(1e5 + Math.random() * 9e5);
...
// .wrangler/tmp/bundle-1JJxO0/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-1JJxO0/middleware-loader.entry.ts
