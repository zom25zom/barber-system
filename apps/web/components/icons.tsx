// Custom SVG brand & UI icons (Lucide-style stroke icons + official brand glyphs)
// Usage: <IconFacebook className="h-4 w-4" />
...
/** Calendar Plus — Lucide-style stroke icon */
export function IconCalendarPlus({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** Clipboard List — Lucide-style stroke icon */
...
/** MapPin — Lucide-style stroke icon */
...
/** Phone — Lucide-style stroke icon */
